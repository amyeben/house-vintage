  ...
  return (<>
      ...
      <div className={"main-content"}>
          ...
          <div className={"homePageCards1"}>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pants.png"} id={1} articleName={"Pants 1"} articlePrice={"182£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant2.png"} id={2} articleName={"Pants 2"} articlePrice={"145£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant3.png"} id={3} articleName={"Pants 3"} articlePrice={"725£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pants.png"} id={4} articleName={"Pants 4"} articlePrice={"12£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant2.png"} id={5} articleName={"Pants 5"} articlePrice={"245£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant3.png"} id={6} articleName={"Pants 6"} articlePrice={"765£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pants.png"} id={7} articleName={"Pants 7"} articlePrice={"932£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant2.png"} id={8} articleName={"Pants 8"} articlePrice={"225£"}/>
              <ProductPresentation srcImage={"/../public/img/imgClothing/imgPants/pant3.png"} id={9} articleName={"Pants 9"} articlePrice={"75£"}/>
          </div>
          <SummerDiscount />
